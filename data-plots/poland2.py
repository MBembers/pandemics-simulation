...
plt.xlabel('Date')
plt.ylabel('Count')
plt.title('Total Cases and Total Deaths in Poland Over Time (Logarithmic Scale)')
plt.legend()
plt.tight_layout()
plt.show()
...
plt.xlabel('Date')
plt.ylabel('Count')
plt.title('New Cases and New Deaths in Poland Over Time (Logarithmic Scale)')
plt.legend()
plt.tight_layout()
plt.show()
...
plt.xlabel('Date')
plt.ylabel('Count')
plt.title('Total Number of People Vaccinated and New Vaccinations in Poland Over Time (Logarithmic Scale)')
plt.legend()
plt.tight_layout()
plt.show()
...
plt.xlabel('Date')
plt.ylabel('Count')
plt.title('Number of Hospitalized Patients and ICU Patients in Poland Over Time (Logarithmic Scale)')
plt.legend()
...
plt.xlabel('Date')
plt.ylabel('Count')
plt.title('New Cases and Total Cases in Poland Over Time (Logarithmic Scale)')
plt.legend()
plt.tight_layout()
plt.show()
...
plt.xlabel('Date')
plt.ylabel('Count')
plt.title('New Deaths and Total Deaths in Poland Over Time (Logarithmic Scale)')
plt.legend()
plt.tight_layout()
plt.show()
...
plt.xlabel('Date')
plt.ylabel('Count')
plt.title('ICU Patients and New Deaths in Poland Over Time (Logarithmic Scale)')
plt.legend()
